//! Autogenerated: unsaturated_solinas --lang Rust --inline -o 'fieldp521/ops.rs' p521 64 '(auto)' '2^521 - 1' carry relax to_bytes from_bytes add sub opp carry_add carry_sub carry_opp carry_mul carry_square selectznz
//! curve description: p521
//! machine_wordsize = 64 (from "64")
//! requested operations: carry, relax, to_bytes, from_bytes, add, sub, opp, carry_add, carry_sub, carry_opp, carry_mul, carry_square, selectznz
//! n = 9 (from "(auto)")
